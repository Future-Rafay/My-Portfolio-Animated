    ...
    return (
        <footer className="w-full border-t-2 border-solid border-dark dark:text-light dark:border-light">
            <Layout className="py-8 flex items-center justify-between font-medium">
                ...
                <div className="flex items-center">Build With<span className="text-2xl px-1 text-primary dark:text-primaryDark">&#9825;</span>by&nbsp;<Link href='/' target="_blank" className="underline underline-offset-4">Future-Rafay</Link></div>
