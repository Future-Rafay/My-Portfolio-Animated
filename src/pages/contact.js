...
//         {/* TEXT CONTAINER */}
//         <div className="flex items-center justify-center text-5xl lg:text-6xl text-center">
//           <div>
...
//           onSubmit={sendEmail}
//           ref={form}
//           className="bg-red-50 rounded-xl text-xl flex flex-col gap-6 p-8 shadow-lg"
//         >
