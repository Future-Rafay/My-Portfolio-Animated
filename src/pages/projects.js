...
import FeaturedProjectFoodeezImage from "../../public/images/projects/foodeez.png";
        ...
        <Layout className="pt-16">
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-36 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            <div className="col-span-12">
              <FeaturedProject
                type="Startup Admin Platform"
                title="Foodeez"
                summary="Foodeez is a modern business management platform built for food startups. It includes a dedicated admin panel (admin.foodeez.ch) for managing businesses, products, and orders. Built with Next.js 15, TypeScript, Prisma, MySQL, and shadcn/ui, the platform offers smooth authentication, scalable architecture, and a clean, responsive UI designed for operational efficiency."
                link="https://foodeez.ch/"
                gitHubLink="https://github.com/Future-Rafay/foodeez.ch"
                image={FeaturedProjectFoodeezImage}
              />
            </div>
            <div className="col-span-12">
              <FeaturedProject
