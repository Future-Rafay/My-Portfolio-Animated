        ...
        <>
            ...
            <main className="flex flex-col w-full items-center justify-center dark:text-light ">
                <Layout className="pt-16">
                    <AnimatedText text="The Story So Far" className="mb-16 lg:!text-7xl sm:!text-6xl xs:!text-4xl sm:mb-8" />
                    <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
                        ...
                        <div className="col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light dark:bg-dark dark:border-light p-4 xl:col-span-4  
                        ...
                        ">
                            <div className="flex flex-col items-end justify-center xl:items-center">
                                <span className="text-7xl font-bold inline-block md:text-6xl sm:text-5xl xs:text-4xl">11+</span>
                            ...
                            <div className="flex flex-col items-end justify-center xl:items-center">
                                <span className="text-7xl font-bold inline-block md:text-6xl sm:text-5xl xs:text-4xl">8+</span>
                                <h2 className="text-dark/75 text-xl font-medium capitalize dark:text-light/75 xl:text-center md:text-lg sm:text-base xs:text-sm">
                                    projects completed
                                </h2>
                            </div>
                            <div className="flex flex-col items-end justify-center xl:items-center">
                                <span className="text-7xl font-bold inline-block md:text-6xl sm:text-5xl xs:text-4xl">7+</span>
                                <h2 className="text-dark/75 text-xl font-medium capitalize dark:text-light/75 xl:text-center md:text-lg sm:text-base xs:text-sm">
