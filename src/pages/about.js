            ...
            <main className="flex flex-col w-full items-center justify-center ">
                <Layout className="pt-16">
                    ...
                    <div className="grid w-full grid-cols-8 gap-16">
                        ...
                        <div className="col-span-3 relative rounded-2xl border-2 border-solid border-dark bg-light p-4">
                        ...
                        <div className="col-span-2 flex flex-col items-end justify-between">
                            <div className="flex flex-col items-end justify-center">
                                ...
                                <h2 className="text-dark/75 text-xl font-medium capitalize">satisfied clients</h2>
                            </div>
                            <div className="flex flex-col items-end justify-center">
                                <span className="text-7xl font-bold inline-block">8+</span>
                                <h2 className="text-dark/75 text-xl font-medium capitalize" >projects completed</h2>
                            </div>
                            <div className="flex flex-col items-end justify-center">
                                <span className="text-7xl font-bold inline-block">1+</span>
                                <h2 className="text-dark/75 text-xl font-medium capitalize">years of experiance</h2>
                            </div>
                        </div>
                    </div>  
                </Layout>
